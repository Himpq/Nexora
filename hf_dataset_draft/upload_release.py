"""Upload a prepared KwExt dataset release without exposing the HF token."""
...
def main() -> None:
    ...
    files = (
        (RELEASE_DIR / "README.md", "README.md"),
        (RELEASE_DIR / "manifest.json", "manifest.json"),
        (RELEASE_DIR / "quality_report.json", "quality_report.json"),
        (
            RELEASE_DIR / "data" / "bilibili_video_title_annotations.jsonl",
            "data/bilibili_video_title_annotations.jsonl",
        ),
    )
    ...
    for local_path, remote_path in files:
        ...
        info = api.upload_file(
            ...
            repo_id=REPO_ID,
            repo_type="dataset",
            commit_message="Add KwExt Bilibili title annotation v0.1",
        )
